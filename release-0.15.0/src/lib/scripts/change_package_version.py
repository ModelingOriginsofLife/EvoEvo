...
def modify_version( path, package, major, minor, patch ):
	...
	f.write("Developers:\n")
	f.write("-----------\n")
	f.write("To modify the version, use the python script\n")
	f.write("\"change_package_version.py\" in src/lib/scripts folder.\n")
	f.close()

#-----------------------------#
# MODIFY PACKAGE FILE         #
#-----------------------------#
def modify_package( path, package, major, minor, patch ):
	f = open(path+"PACKAGE", "w")
	f.write("Package name: "+package+"\n")
	f.write("\n")
	f.write("\n")
	f.write("Developers:\n")
	f.write("-----------\n")
	f.write("To modify the package name, use the python script\n")
	f.write("\"change_package_version.py\" in src/lib/scripts folder.\n")
	f.close()
...
if __name__ == '__main__':
	...
	modify_package(PATH, PACKAGE, MAJOR, MINOR, PATCH)
