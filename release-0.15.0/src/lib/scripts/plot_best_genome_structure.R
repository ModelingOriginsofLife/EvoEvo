...
# 3) Open data                        #
#-------------------------------------#
data = read.table("./statistics/genome_structure_best.txt", h=T, sep=" ")
...
###############################################
#     ENZYME PEARLS COMPOSITION PIE CHART     #
###############################################
png("./figures/enzyme_pearls_composition_piechart.png", width=800, height=800, pointsize=20)
par(mfrow=c(1,1), mar=c(5,5,5,5))
