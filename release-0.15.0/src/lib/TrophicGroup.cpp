...
TrophicGroup::TrophicGroup( unsigned long long int identifier, size_t time, double red, double green, double blue )
{
  ...
  /* GENETIC DIVERSITY */
  _true_diversity              = 0.0;
  _max_time_distance           = 0.0;
  _max_generation_distance     = 0.0;
  _max_point_mutation_distance = 0.0;
  _max_hgt_distance            = 0.0;
  _max_duplication_distance    = 0.0;
  _max_deletion_distance       = 0.0;
  _max_inversion_distance      = 0.0;
  _max_translocation_distance  = 0.0;
...
TrophicGroup::TrophicGroup( gzFile backup_file )
{
  ...
  /* GENETIC DIVERSITY */
  gzread( backup_file, &_true_diversity,              sizeof(_true_diversity) );
  gzread( backup_file, &_max_time_distance,           sizeof(_max_time_distance) );
  gzread( backup_file, &_max_generation_distance,     sizeof(_max_generation_distance) );
  gzread( backup_file, &_max_point_mutation_distance, sizeof(_max_point_mutation_distance) );
  gzread( backup_file, &_max_hgt_distance,            sizeof(_max_hgt_distance) );
  gzread( backup_file, &_max_duplication_distance,    sizeof(_max_duplication_distance) );
  gzread( backup_file, &_max_deletion_distance,       sizeof(_max_deletion_distance) );
  gzread( backup_file, &_max_inversion_distance,      sizeof(_max_inversion_distance) );
  gzread( backup_file, &_max_translocation_distance,  sizeof(_max_translocation_distance) );
...
TrophicGroup::TrophicGroup( const TrophicGroup& trophic_group )
{
  ...
  /* GENETIC DIVERSITY */
  _true_diversity              = trophic_group._true_diversity;
  _max_time_distance           = trophic_group._max_time_distance;
  _max_generation_distance     = trophic_group._max_generation_distance;
  _max_point_mutation_distance = trophic_group._max_point_mutation_distance;
  _max_hgt_distance            = trophic_group._max_hgt_distance;
  _max_duplication_distance    = trophic_group._max_duplication_distance;
  _max_deletion_distance       = trophic_group._max_deletion_distance;
  _max_inversion_distance      = trophic_group._max_inversion_distance;
  _max_translocation_distance  = trophic_group._max_translocation_distance;
...
void TrophicGroup::save( gzFile backup_file )
{
  ...
  /* GENETIC DIVERSITY */
  gzwrite( backup_file, &_true_diversity,              sizeof(_true_diversity) );
  gzwrite( backup_file, &_max_time_distance,           sizeof(_max_time_distance) );
  gzwrite( backup_file, &_max_generation_distance,     sizeof(_max_generation_distance) );
  gzwrite( backup_file, &_max_point_mutation_distance, sizeof(_max_point_mutation_distance) );
  gzwrite( backup_file, &_max_hgt_distance,            sizeof(_max_hgt_distance) );
  gzwrite( backup_file, &_max_duplication_distance,    sizeof(_max_duplication_distance) );
  gzwrite( backup_file, &_max_deletion_distance,       sizeof(_max_deletion_distance) );
  gzwrite( backup_file, &_max_inversion_distance,      sizeof(_max_inversion_distance) );
  gzwrite( backup_file, &_max_translocation_distance,  sizeof(_max_translocation_distance) );
...
void TrophicGroup::add_alive_cell( Parameters* parameters, Cell* cell )
{
  ...
  /* INHERITED STRUCTURE */
  if (parameters->get_enzymatic_inheritance())
  {
