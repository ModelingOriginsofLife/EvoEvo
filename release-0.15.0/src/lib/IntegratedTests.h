...
public:
  ...
  Simulation* create_experiment( Parameters* parameters, unsigned long int seed );
  void        test_experiment_creation( unsigned long int seed );
  bool        test_experiment_execution( size_t backup_time, size_t simulation_time );
