...
public:
  ...
  inline std::string                          get_trophic_profile( void ) const;
  inline std::string                          get_production_profile( void ) const;
  inline std::string                          get_uptake_profile( void ) const;
  inline std::string                          get_release_profile( void ) const;
  ...
  /* GENETIC DIVERSITY */
  inline double get_true_diversity( void ) const;
  inline double get_max_time_distance( void ) const;
  inline double get_max_generation_distance( void ) const;
  inline double get_max_point_mutation_distance( void ) const;
  inline double get_max_hgt_distance( void ) const;
  inline double get_max_duplication_distance( void ) const;
  inline double get_max_deletion_distance( void ) const;
  inline double get_max_inversion_distance( void ) const;
  inline double get_max_translocation_distance( void ) const;
  ...
  inline void set_trophic_profile( std::string trophic_profile );
  inline void set_production_profile( std::string production_profile );
  inline void set_uptake_profile( std::string uptake_profile );
  inline void set_release_profile( std::string release_profile );
  ...
  /* GENETIC DIVERSITY */
  inline void set_true_diversity( double true_diversity );
  inline void set_max_time_distance( double max_time_distance );
  inline void set_max_generation_distance( double max_generation_distance );
  inline void set_max_point_mutation_distance( double max_point_mutation_distance );
  inline void set_max_hgt_distance( double max_hgt_distance );
  inline void set_max_duplication_distance( double max_duplication_distance );
  inline void set_max_deletion_distance( double max_deletion_distance );
  inline void set_max_inversion_distance( double max_inversion_distance );
  inline void set_max_translocation_distance( double max_translocation_distance );
...
protected:
  ...
  /* GENETIC DIVERSITY */
  double _true_diversity;              /*!< True diversity measure          */
  double _max_time_distance;           /*!< Maximum time distance           */
  double _max_generation_distance;     /*!< Maximum generation distance     */
  double _max_point_mutation_distance; /*!< Maximum point mutation distance */
  double _max_hgt_distance;            /*!< Maximum HGT distance            */
  double _max_duplication_distance;    /*!< Maximum duplication distance    */
  double _max_deletion_distance;       /*!< Maximum deletion distance       */
  double _max_inversion_distance;      /*!< Maximum inversion distance      */
  double _max_translocation_distance;  /*!< Maximum translocation distance  */
...
/**
 * \brief    Get the trophic profile
 * \details  --
 * \param    void
 * \return   \e std::string
 */
inline std::string TrophicGroup::get_trophic_profile( void ) const
{
  return _trophic_profile;
}

/**
 * \brief    Get the production profile
 * \details  --
 * \param    void
 * \return   \e std::string
 */
inline std::string TrophicGroup::get_production_profile( void ) const
{
  return _production_profile;
}

/**
 * \brief    Get the uptake profile
 * \details  --
 * \param    void
 * \return   \e std::string
 */
inline std::string TrophicGroup::get_uptake_profile( void ) const
{
  return _uptake_profile;
}

/**
 * \brief    Get the release profile
 * \details  --
 * \param    void
 * \return   \e std::string
 */
inline std::string TrophicGroup::get_release_profile( void ) const
{
  return _release_profile;
}
...
/**
 * \brief    Get the true diversity measure
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_true_diversity( void ) const
{
  return _true_diversity;
}

/**
 * \brief    Get the maximum time distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_time_distance( void ) const
{
  return _max_time_distance;
}

/**
 * \brief    Get the maximum generation distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_generation_distance( void ) const
{
  return _max_generation_distance;
}

/**
 * \brief    Get the maximum point mutation distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_point_mutation_distance( void ) const
{
  return _max_point_mutation_distance;
}

/**
 * \brief    Get the maximum HGT distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_hgt_distance( void ) const
{
  return _max_hgt_distance;
}

/**
 * \brief    Get the maximum duplication distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_duplication_distance( void ) const
{
  return _max_duplication_distance;
}

/**
 * \brief    Get the maximum deletion distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_deletion_distance( void ) const
{
  return _max_deletion_distance;
}

/**
 * \brief    Get the maximum inversion distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_inversion_distance( void ) const
{
  return _max_inversion_distance;
}

/**
 * \brief    Get the maximum translocation distance
 * \details  --
 * \param    double
 * \return   \e void
 */
inline double TrophicGroup::get_max_translocation_distance( void ) const
{
  return _max_translocation_distance;
}
...
/**
 * \brief    Get the mean number of NC pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of E pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of TF pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of BS pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of P pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of inherited E pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Get the mean number of inherited TF pearls
 * \details  --
 * \param    double
 * \return   \e void
 */
...
/**
 * \brief    Set the trophic profile
 * \details  --
 * \param    std::string trophic_profile
 * \return   \e void
 */
inline void TrophicGroup::set_trophic_profile( std::string trophic_profile )
{
  _trophic_profile = trophic_profile;
}
...
/**
 * \brief    Set the true diversity measure
 * \details  --
 * \param    double true_diversity
 * \return   \e void
 */
inline void TrophicGroup::set_true_diversity( double true_diversity )
{
  assert(true_diversity >= 0.0);
  _true_diversity = true_diversity;
}

/**
 * \brief    Set the maximum time distance
 * \details  --
 * \param    double max_time_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_time_distance( double max_time_distance )
{
  assert(max_time_distance >= 0.0);
  _max_time_distance = max_time_distance;
}

/**
 * \brief    Set the maximum generation distance
 * \details  --
 * \param    double max_generation_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_generation_distance( double max_generation_distance )
{
  assert(max_generation_distance >= 0.0);
  _max_generation_distance = max_generation_distance;
}

/**
 * \brief    Set the maximum point mutation distance
 * \details  --
 * \param    double max_point_mutation_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_point_mutation_distance( double max_point_mutation_distance )
{
  assert(max_point_mutation_distance >= 0.0);
  _max_point_mutation_distance = max_point_mutation_distance;
}

/**
 * \brief    Set the maximum HGT distance
 * \details  --
 * \param    double max_hgt_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_hgt_distance( double max_hgt_distance )
{
  assert(max_hgt_distance >= 0.0);
  _max_hgt_distance = max_hgt_distance;
}

/**
 * \brief    Set the maximum duplication distance
 * \details  --
 * \param    double max_duplication_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_duplication_distance( double max_duplication_distance )
{
  assert(max_duplication_distance >= 0.0);
  _max_duplication_distance = max_duplication_distance;
}

/**
 * \brief    Set the maximum deletion distance
 * \details  --
 * \param    double max_deletion_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_deletion_distance( double max_deletion_distance )
{
  assert(max_deletion_distance >= 0.0);
  _max_deletion_distance = max_deletion_distance;
}

/**
 * \brief    Set the maximum inversion distance
 * \details  --
 * \param    double max_inversion_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_inversion_distance( double max_inversion_distance )
{
  assert(max_inversion_distance >= 0.0);
  _max_inversion_distance = max_inversion_distance;
}

/**
 * \brief    Set the maximum translocation distance
 * \details  --
 * \param    double max_translocation_distance
 * \return   \e void
 */
inline void TrophicGroup::set_max_translocation_distance( double max_translocation_distance )
{
  assert(max_translocation_distance >= 0.0);
  _max_translocation_distance = max_translocation_distance;
}

/**
 * \brief    Set the production profile
 * \details  --
 * \param    std::string production_profile
 * \return   \e void
 */
inline void TrophicGroup::set_production_profile( std::string production_profile )
{
  _production_profile = std::string(production_profile);
}

/**
 * \brief    Set the uptake profile
 * \details  --
 * \param    std::string uptake_profile
 * \return   \e void
 */
inline void TrophicGroup::set_uptake_profile( std::string uptake_profile )
{
  _uptake_profile = std::string(uptake_profile);
}

/**
 * \brief    Set the release profile
 * \details  --
 * \param    std::string release_profile
 * \return   \e void
 */
inline void TrophicGroup::set_release_profile( std::string release_profile )
{
  _release_profile = std::string(release_profile);
}
