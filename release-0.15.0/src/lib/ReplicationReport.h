...
public:
  ...
  inline double get_mean_km_mutation_size( void ) const;
...
protected:
  ...
  size_t _genome_nb_NC;            /*!< Number of genome NC pearls         */
  size_t _genome_nb_E;             /*!< Number of genome E pearls          */
  size_t _genome_nb_TF;            /*!< Number of genome TF pearls         */
  size_t _genome_nb_BS;            /*!< Number of genome BS pearls         */
  size_t _genome_nb_P;             /*!< Number of genome NC pearls         */
  ...
  double _mean_regulation_redundancy; /*!< Mean redundancy for TF pearls */
  double _mean_metabolic_redundancy;  /*!< Mean redundancy for E pearls  */
  
  /*------------------------------------------------------------------ Inherited proteins structure (6) */
  
  size_t _inherited_size;             /*!< Inherited size                       */
  size_t _inherited_nb_E;             /*!< Number of inherited E pearls         */
  size_t _inherited_nb_TF;            /*!< Number of inherited TF pearls        */
  ...
  double _mean_km_mutation_size;   /*!< Mean Km constant mutation sizes   */
  ...
  size_t _nb_NC_HGT;     /*!< Number of NC pearl HGT */
  size_t _nb_E_HGT;      /*!< Number of E pearl HGT  */
  size_t _nb_TF_HGT;     /*!< Number of TF pearl HGT */
  size_t _nb_BS_HGT;     /*!< Number of BS pearl HGT */
  size_t _nb_P_HGT;      /*!< Number of P pearl HGT  */
...
/**
 * \brief    Get the mean size of Km constant mutations
 * \details  --
 * \param    void
 * \return   \e double
 */
inline double ReplicationReport::get_mean_km_mutation_size( void ) const
{
  return _mean_km_mutation_size;
}
...
/**
 * \brief    Get the number of NC pearl HGT
 * \details  --
 * \param    void
 * \return   \e size_t
 */
...
/**
 * \brief    Get the number of E pearl HGT
 * \details  --
 * \param    void
 * \return   \e size_t
 */
...
/**
 * \brief    Get the number of TF pearl HGT
 * \details  --
 * \param    void
 * \return   \e size_t
 */
...
/**
 * \brief    Get the number of BS pearl HGT
 * \details  --
 * \param    void
 * \return   \e size_t
 */
...
/**
 * \brief    Get the number of P pearl HGT
 * \details  --
 * \param    void
 * \return   \e size_t
 */
